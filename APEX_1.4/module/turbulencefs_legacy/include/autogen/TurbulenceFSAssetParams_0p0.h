...
static const uint32_t checksum[] = { 0x60827838, 0x801870ba, 0xa303c521, 0x0b9ee96e, };

} // namespace TurbulenceFSAssetParams_0p0NS

#ifndef NV_PARAMETERIZED_ONLY_LAYOUTS
class TurbulenceFSAssetParams_0p0 : public NvParameterized::NvParameters, public TurbulenceFSAssetParams_0p0NS::ParametersStruct
{
public:
	TurbulenceFSAssetParams_0p0(NvParameterized::Traits* traits, void* buf = 0, int32_t* refCount = 0);
...
class TurbulenceFSAssetParams_0p0Factory : public NvParameterized::Factory
{
...
public:
	...
	{
		TurbulenceFSAssetParams_0p0::freeParameterDefinitionTable(traits);
	}
	...
	virtual NvParameterized::Interface* create(NvParameterized::Traits* paramTraits)
	{
		...
		if (!NvParameterized::IsAligned(newPtr, TurbulenceFSAssetParams_0p0::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSAssetParams_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(TurbulenceFSAssetParams_0p0)); // always initialize memory allocated to zero for default values
		return NV_PARAM_PLACEMENT_NEW(newPtr, TurbulenceFSAssetParams_0p0)(paramTraits);
	}

	virtual NvParameterized::Interface* finish(NvParameterized::Traits* paramTraits, void* bufObj, void* bufStart, int32_t* refCount)
	{
		if (!NvParameterized::IsAligned(bufObj, TurbulenceFSAssetParams_0p0::ClassAlignment)
		        || !NvParameterized::IsAligned(bufStart, TurbulenceFSAssetParams_0p0::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSAssetParams_0p0");
			return 0;
		}
