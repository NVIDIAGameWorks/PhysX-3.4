...
static const uint32_t checksum[] = { 0x3a061dd2, 0xcb94cf6a, 0x91aa4c66, 0xdb4642a5, };

} // namespace TurbulenceFSAssetParams_0p4NS

#ifndef NV_PARAMETERIZED_ONLY_LAYOUTS
class TurbulenceFSAssetParams_0p4 : public NvParameterized::NvParameters, public TurbulenceFSAssetParams_0p4NS::ParametersStruct
{
public:
	TurbulenceFSAssetParams_0p4(NvParameterized::Traits* traits, void* buf = 0, int32_t* refCount = 0);
...
class TurbulenceFSAssetParams_0p4Factory : public NvParameterized::Factory
{
...
public:
	...
	{
		TurbulenceFSAssetParams_0p4::freeParameterDefinitionTable(traits);
	}
	...
	virtual NvParameterized::Interface* create(NvParameterized::Traits* paramTraits)
	{
		...
		if (!NvParameterized::IsAligned(newPtr, TurbulenceFSAssetParams_0p4::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSAssetParams_0p4");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(TurbulenceFSAssetParams_0p4)); // always initialize memory allocated to zero for default values
		return NV_PARAM_PLACEMENT_NEW(newPtr, TurbulenceFSAssetParams_0p4)(paramTraits);
	}

	virtual NvParameterized::Interface* finish(NvParameterized::Traits* paramTraits, void* bufObj, void* bufStart, int32_t* refCount)
	{
		if (!NvParameterized::IsAligned(bufObj, TurbulenceFSAssetParams_0p4::ClassAlignment)
		        || !NvParameterized::IsAligned(bufStart, TurbulenceFSAssetParams_0p4::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSAssetParams_0p4");
			return 0;
		}
