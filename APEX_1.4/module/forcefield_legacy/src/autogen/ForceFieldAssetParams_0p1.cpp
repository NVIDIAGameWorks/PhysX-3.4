...
const char* const ForceFieldAssetParams_0p1Factory::vptr =
    NvParameterized::getVptr<ForceFieldAssetParams_0p1, ForceFieldAssetParams_0p1::ClassAlignment>();
...
NvParameterized::MutexType ForceFieldAssetParams_0p1::mBuiltFlagMutex;

ForceFieldAssetParams_0p1::ForceFieldAssetParams_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* ForceFieldAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* ForceFieldAssetParams_0p1::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType ForceFieldAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType ForceFieldAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldAssetParams_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
