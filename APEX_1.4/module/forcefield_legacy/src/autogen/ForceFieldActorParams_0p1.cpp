...
using namespace ForceFieldActorParams_0p1NS;

const char* const ForceFieldActorParams_0p1Factory::vptr =
    NvParameterized::getVptr<ForceFieldActorParams_0p1, ForceFieldActorParams_0p1::ClassAlignment>();
...
bool ForceFieldActorParams_0p1::mBuiltFlag = false;
NvParameterized::MutexType ForceFieldActorParams_0p1::mBuiltFlagMutex;

ForceFieldActorParams_0p1::ForceFieldActorParams_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ForceFieldActorParams_0p1FactoryInst);
...
ForceFieldActorParams_0p1::~ForceFieldActorParams_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ForceFieldActorParams_0p1::destroy()
{
	...
	this->~ForceFieldActorParams_0p1();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* ForceFieldActorParams_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* ForceFieldActorParams_0p1::getParameterDefinitionTree(void) const
{
	ForceFieldActorParams_0p1* tmpParam = const_cast<ForceFieldActorParams_0p1*>(this);
...
NvParameterized::ErrorType ForceFieldActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType ForceFieldActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldActorParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ForceFieldActorParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ForceFieldActorParams_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ForceFieldActorParams_0p1::buildTree(void)
{
...
void ForceFieldActorParams_0p1::initStrings(void)
{
...
void ForceFieldActorParams_0p1::initDynamicArrays(void)
{
}

void ForceFieldActorParams_0p1::initDefaults(void)
{
...
void ForceFieldActorParams_0p1::initReferences(void)
{
}

void ForceFieldActorParams_0p1::freeDynamicArrays(void)
{
}

void ForceFieldActorParams_0p1::freeStrings(void)
{
...
void ForceFieldActorParams_0p1::freeReferences(void)
{
}
