...
const char* const GenericForceFieldKernelParams_0p0Factory::vptr =
    NvParameterized::getVptr<GenericForceFieldKernelParams_0p0, GenericForceFieldKernelParams_0p0::ClassAlignment>();
...
NvParameterized::MutexType GenericForceFieldKernelParams_0p0::mBuiltFlagMutex;

GenericForceFieldKernelParams_0p0::GenericForceFieldKernelParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* GenericForceFieldKernelParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* GenericForceFieldKernelParams_0p0::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType GenericForceFieldKernelParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType GenericForceFieldKernelParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GenericForceFieldKernelParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
