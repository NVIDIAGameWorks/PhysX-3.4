...
#ifndef MODULE_MODULEFORCEFIELDLEGACYREGISTRATIONH_H
#define MODULE_MODULEFORCEFIELDLEGACYREGISTRATIONH_H
...
#include "ForceFieldAssetPreviewParams_0p0.h"
#include "ForceFieldDebugRenderParams_0p0.h"
#include "ForceFieldFalloffParams_0p0.h"
#include "ForceFieldNoiseParams_0p0.h"
#include "GenericForceFieldKernelParams_0p1.h"
#include "RadialForceFieldKernelParams_0p0.h"
#include "ForceFieldModuleParams_0p0.h"


// INCLUDE GENERATED CONVERSION
#include "ConversionForceFieldActorParams_0p0_0p1.h"
...
class ModuleForceFieldLegacyRegistration : public NvParameterized::RegistrationsForTraitsBase
{
public:
	static void invokeRegistration(NvParameterized::Traits* parameterizedTraits)
	{
		...
		{
			ModuleForceFieldLegacyRegistration().registerAll(*parameterizedTraits);
		}
	}
	...
	static void invokeUnregistration(NvParameterized::Traits* parameterizedTraits)
	{
		if (parameterizedTraits)
		{
			ModuleForceFieldLegacyRegistration().unregisterAll(*parameterizedTraits);
		}
	}
...
// REGISTER GENERATED FACTORIES
			new nvidia::parameterized::ForceFieldActorParams_0p0Factory(),
			new nvidia::parameterized::ForceFieldAssetParams_0p0Factory(),
			new nvidia::parameterized::GenericForceFieldKernelParams_0p0Factory(),
...
// REGISTER GENERATED CONVERSION
			{
			typedef nvidia::apex::legacy::ConversionForceFieldActorParams_0p0_0p1 ConverterToRegister;
			...
			{
			typedef nvidia::apex::legacy::ConversionForceFieldAssetParams_0p0_0p1 ConverterToRegister;
			parameterizedTraits.registerConversion(ConverterToRegister::TOldClass::staticClassName(),
								ConverterToRegister::TOldClass::ClassVersion,
								ConverterToRegister::TNewClass::ClassVersion,
								*(ConverterToRegister::Create(&parameterizedTraits)));
			...
			{
			typedef nvidia::apex::legacy::ConversionGenericForceFieldKernelParams_0p0_0p1 ConverterToRegister;
			parameterizedTraits.registerConversion(ConverterToRegister::TOldClass::staticClassName(),
								ConverterToRegister::TOldClass::ClassVersion,
								ConverterToRegister::TNewClass::ClassVersion,
								*(ConverterToRegister::Create(&parameterizedTraits)));
...
// UNREGISTER GENERATED CONVERSION
			{
			typedef nvidia::apex::legacy::ConversionForceFieldActorParams_0p0_0p1 ConverterToUnregister;
			...
			{
			typedef nvidia::apex::legacy::ConversionForceFieldAssetParams_0p0_0p1 ConverterToUnregister;
			::NvParameterized::Conversion* removedConv = parameterizedTraits.removeConversion(ConverterToUnregister::TOldClass::staticClassName(),
								ConverterToUnregister::TOldClass::ClassVersion,
								ConverterToUnregister::TNewClass::ClassVersion);
			if (removedConv) {
			...
			{
			typedef nvidia::apex::legacy::ConversionGenericForceFieldKernelParams_0p0_0p1 ConverterToUnregister;
			::NvParameterized::Conversion* removedConv = parameterizedTraits.removeConversion(ConverterToUnregister::TOldClass::staticClassName(),
								ConverterToUnregister::TOldClass::ClassVersion,
								ConverterToUnregister::TNewClass::ClassVersion);
			if (removedConv) {
