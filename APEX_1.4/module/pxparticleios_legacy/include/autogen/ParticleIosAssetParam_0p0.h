...
static const uint32_t checksum[] = { 0x6ade1528, 0x48d5e8e8, 0x974dda3a, 0xd10d8d0a, };

} // namespace ParticleIosAssetParam_0p0NS

#ifndef NV_PARAMETERIZED_ONLY_LAYOUTS
class ParticleIosAssetParam_0p0 : public NvParameterized::NvParameters, public ParticleIosAssetParam_0p0NS::ParametersStruct
{
public:
	ParticleIosAssetParam_0p0(NvParameterized::Traits* traits, void* buf = 0, int32_t* refCount = 0);
...
class ParticleIosAssetParam_0p0Factory : public NvParameterized::Factory
{
...
public:
	...
	{
		ParticleIosAssetParam_0p0::freeParameterDefinitionTable(traits);
	}
	...
	virtual NvParameterized::Interface* create(NvParameterized::Traits* paramTraits)
	{
		...
		if (!NvParameterized::IsAligned(newPtr, ParticleIosAssetParam_0p0::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ParticleIosAssetParam_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ParticleIosAssetParam_0p0)); // always initialize memory allocated to zero for default values
		return NV_PARAM_PLACEMENT_NEW(newPtr, ParticleIosAssetParam_0p0)(paramTraits);
	}

	virtual NvParameterized::Interface* finish(NvParameterized::Traits* paramTraits, void* bufObj, void* bufStart, int32_t* refCount)
	{
		if (!NvParameterized::IsAligned(bufObj, ParticleIosAssetParam_0p0::ClassAlignment)
		        || !NvParameterized::IsAligned(bufStart, ParticleIosAssetParam_0p0::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ParticleIosAssetParam_0p0");
			return 0;
		}
