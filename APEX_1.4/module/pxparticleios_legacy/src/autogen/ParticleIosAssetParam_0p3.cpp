...
const char* const ParticleIosAssetParam_0p3Factory::vptr =
    NvParameterized::getVptr<ParticleIosAssetParam_0p3, ParticleIosAssetParam_0p3::ClassAlignment>();
...
NvParameterized::MutexType ParticleIosAssetParam_0p3::mBuiltFlagMutex;

ParticleIosAssetParam_0p3::ParticleIosAssetParam_0p3(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* ParticleIosAssetParam_0p3::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* ParticleIosAssetParam_0p3::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType ParticleIosAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType ParticleIosAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosAssetParam_0p3::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
