...
const char* const ParticleIosAssetParam_0p1Factory::vptr =
    NvParameterized::getVptr<ParticleIosAssetParam_0p1, ParticleIosAssetParam_0p1::ClassAlignment>();
...
NvParameterized::MutexType ParticleIosAssetParam_0p1::mBuiltFlagMutex;

ParticleIosAssetParam_0p1::ParticleIosAssetParam_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* ParticleIosAssetParam_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* ParticleIosAssetParam_0p1::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType ParticleIosAssetParam_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType ParticleIosAssetParam_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosAssetParam_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
