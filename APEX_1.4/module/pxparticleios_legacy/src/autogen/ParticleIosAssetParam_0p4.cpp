...
const char* const ParticleIosAssetParam_0p4Factory::vptr =
    NvParameterized::getVptr<ParticleIosAssetParam_0p4, ParticleIosAssetParam_0p4::ClassAlignment>();
...
NvParameterized::MutexType ParticleIosAssetParam_0p4::mBuiltFlagMutex;

ParticleIosAssetParam_0p4::ParticleIosAssetParam_0p4(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* ParticleIosAssetParam_0p4::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* ParticleIosAssetParam_0p4::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType ParticleIosAssetParam_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType ParticleIosAssetParam_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosAssetParam_0p4::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
