...
using namespace AttractorFSActorParams_0p1NS;

const char* const AttractorFSActorParams_0p1Factory::vptr =
    NvParameterized::getVptr<AttractorFSActorParams_0p1, AttractorFSActorParams_0p1::ClassAlignment>();
...
bool AttractorFSActorParams_0p1::mBuiltFlag = false;
NvParameterized::MutexType AttractorFSActorParams_0p1::mBuiltFlagMutex;

AttractorFSActorParams_0p1::AttractorFSActorParams_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &AttractorFSActorParams_0p1FactoryInst);
...
AttractorFSActorParams_0p1::~AttractorFSActorParams_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void AttractorFSActorParams_0p1::destroy()
{
	...
	this->~AttractorFSActorParams_0p1();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* AttractorFSActorParams_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* AttractorFSActorParams_0p1::getParameterDefinitionTree(void) const
{
	AttractorFSActorParams_0p1* tmpParam = const_cast<AttractorFSActorParams_0p1*>(this);
...
NvParameterized::ErrorType AttractorFSActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType AttractorFSActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFSActorParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<AttractorFSActorParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void AttractorFSActorParams_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void AttractorFSActorParams_0p1::buildTree(void)
{
...
void AttractorFSActorParams_0p1::initStrings(void)
{
...
void AttractorFSActorParams_0p1::initDynamicArrays(void)
{
}

void AttractorFSActorParams_0p1::initDefaults(void)
{
...
void AttractorFSActorParams_0p1::initReferences(void)
{
}

void AttractorFSActorParams_0p1::freeDynamicArrays(void)
{
}

void AttractorFSActorParams_0p1::freeStrings(void)
{
...
void AttractorFSActorParams_0p1::freeReferences(void)
{
}
