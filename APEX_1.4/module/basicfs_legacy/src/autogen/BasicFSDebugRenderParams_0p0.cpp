...
using namespace BasicFSDebugRenderParams_0p0NS;

const char* const BasicFSDebugRenderParams_0p0Factory::vptr =
    NvParameterized::getVptr<BasicFSDebugRenderParams_0p0, BasicFSDebugRenderParams_0p0::ClassAlignment>();
...
bool BasicFSDebugRenderParams_0p0::mBuiltFlag = false;
NvParameterized::MutexType BasicFSDebugRenderParams_0p0::mBuiltFlagMutex;

BasicFSDebugRenderParams_0p0::BasicFSDebugRenderParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicFSDebugRenderParams_0p0FactoryInst);
...
BasicFSDebugRenderParams_0p0::~BasicFSDebugRenderParams_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicFSDebugRenderParams_0p0::destroy()
{
	...
	this->~BasicFSDebugRenderParams_0p0();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* BasicFSDebugRenderParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* BasicFSDebugRenderParams_0p0::getParameterDefinitionTree(void) const
{
	BasicFSDebugRenderParams_0p0* tmpParam = const_cast<BasicFSDebugRenderParams_0p0*>(this);
...
NvParameterized::ErrorType BasicFSDebugRenderParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType BasicFSDebugRenderParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicFSDebugRenderParams_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicFSDebugRenderParams_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicFSDebugRenderParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicFSDebugRenderParams_0p0::buildTree(void)
{
...
void BasicFSDebugRenderParams_0p0::initStrings(void)
{
}

void BasicFSDebugRenderParams_0p0::initDynamicArrays(void)
{
}

void BasicFSDebugRenderParams_0p0::initDefaults(void)
{
...
void BasicFSDebugRenderParams_0p0::initReferences(void)
{
}

void BasicFSDebugRenderParams_0p0::freeDynamicArrays(void)
{
}

void BasicFSDebugRenderParams_0p0::freeStrings(void)
{
}

void BasicFSDebugRenderParams_0p0::freeReferences(void)
{
}
