...
using namespace NoiseFSActorParams_0p0NS;

const char* const NoiseFSActorParams_0p0Factory::vptr =
    NvParameterized::getVptr<NoiseFSActorParams_0p0, NoiseFSActorParams_0p0::ClassAlignment>();
...
bool NoiseFSActorParams_0p0::mBuiltFlag = false;
NvParameterized::MutexType NoiseFSActorParams_0p0::mBuiltFlagMutex;

NoiseFSActorParams_0p0::NoiseFSActorParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &NoiseFSActorParams_0p0FactoryInst);
...
NoiseFSActorParams_0p0::~NoiseFSActorParams_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void NoiseFSActorParams_0p0::destroy()
{
	...
	this->~NoiseFSActorParams_0p0();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* NoiseFSActorParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* NoiseFSActorParams_0p0::getParameterDefinitionTree(void) const
{
	NoiseFSActorParams_0p0* tmpParam = const_cast<NoiseFSActorParams_0p0*>(this);
...
NvParameterized::ErrorType NoiseFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType NoiseFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFSActorParams_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<NoiseFSActorParams_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void NoiseFSActorParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void NoiseFSActorParams_0p0::buildTree(void)
{
...
void NoiseFSActorParams_0p0::initStrings(void)
{
...
void NoiseFSActorParams_0p0::initDynamicArrays(void)
{
}

void NoiseFSActorParams_0p0::initDefaults(void)
{
...
void NoiseFSActorParams_0p0::initReferences(void)
{
}

void NoiseFSActorParams_0p0::freeDynamicArrays(void)
{
}

void NoiseFSActorParams_0p0::freeStrings(void)
{
...
void NoiseFSActorParams_0p0::freeReferences(void)
{
}
