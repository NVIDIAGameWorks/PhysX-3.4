...
using namespace JetFSActorParams_0p0NS;

const char* const JetFSActorParams_0p0Factory::vptr =
    NvParameterized::getVptr<JetFSActorParams_0p0, JetFSActorParams_0p0::ClassAlignment>();
...
bool JetFSActorParams_0p0::mBuiltFlag = false;
NvParameterized::MutexType JetFSActorParams_0p0::mBuiltFlagMutex;

JetFSActorParams_0p0::JetFSActorParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &JetFSActorParams_0p0FactoryInst);
...
JetFSActorParams_0p0::~JetFSActorParams_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void JetFSActorParams_0p0::destroy()
{
	...
	this->~JetFSActorParams_0p0();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* JetFSActorParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* JetFSActorParams_0p0::getParameterDefinitionTree(void) const
{
	JetFSActorParams_0p0* tmpParam = const_cast<JetFSActorParams_0p0*>(this);
...
NvParameterized::ErrorType JetFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType JetFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFSActorParams_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<JetFSActorParams_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void JetFSActorParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void JetFSActorParams_0p0::buildTree(void)
{
...
void JetFSActorParams_0p0::initStrings(void)
{
...
void JetFSActorParams_0p0::initDynamicArrays(void)
{
}

void JetFSActorParams_0p0::initDefaults(void)
{
...
void JetFSActorParams_0p0::initReferences(void)
{
}

void JetFSActorParams_0p0::freeDynamicArrays(void)
{
}

void JetFSActorParams_0p0::freeStrings(void)
{
...
void JetFSActorParams_0p0::freeReferences(void)
{
}
