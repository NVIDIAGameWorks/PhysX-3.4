...
using namespace WindFSActorParams_0p1NS;

const char* const WindFSActorParams_0p1Factory::vptr =
    NvParameterized::getVptr<WindFSActorParams_0p1, WindFSActorParams_0p1::ClassAlignment>();
...
bool WindFSActorParams_0p1::mBuiltFlag = false;
NvParameterized::MutexType WindFSActorParams_0p1::mBuiltFlagMutex;

WindFSActorParams_0p1::WindFSActorParams_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &WindFSActorParams_0p1FactoryInst);
...
void WindFSActorParams_0p1::destroy()
{
	...
	this->~WindFSActorParams_0p1();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* WindFSActorParams_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* WindFSActorParams_0p1::getParameterDefinitionTree(void) const
{
	WindFSActorParams_0p1* tmpParam = const_cast<WindFSActorParams_0p1*>(this);
...
NvParameterized::ErrorType WindFSActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType WindFSActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void WindFSActorParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<WindFSActorParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void WindFSActorParams_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void WindFSActorParams_0p1::buildTree(void)
{
...
void WindFSActorParams_0p1::initStrings(void)
{
...
void WindFSActorParams_0p1::initDynamicArrays(void)
{
}

void WindFSActorParams_0p1::initDefaults(void)
{
...
void WindFSActorParams_0p1::initReferences(void)
{
}

void WindFSActorParams_0p1::freeDynamicArrays(void)
{
}

void WindFSActorParams_0p1::freeStrings(void)
{
...
void WindFSActorParams_0p1::freeReferences(void)
{
}
