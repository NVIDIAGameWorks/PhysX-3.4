...
const char* const NoiseFSAssetParams_0p1Factory::vptr =
    NvParameterized::getVptr<NoiseFSAssetParams_0p1, NoiseFSAssetParams_0p1::ClassAlignment>();
...
NvParameterized::MutexType NoiseFSAssetParams_0p1::mBuiltFlagMutex;

NoiseFSAssetParams_0p1::NoiseFSAssetParams_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* NoiseFSAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* NoiseFSAssetParams_0p1::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType NoiseFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType NoiseFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFSAssetParams_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
