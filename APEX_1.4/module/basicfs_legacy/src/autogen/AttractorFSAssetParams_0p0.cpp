...
const char* const AttractorFSAssetParams_0p0Factory::vptr =
    NvParameterized::getVptr<AttractorFSAssetParams_0p0, AttractorFSAssetParams_0p0::ClassAlignment>();
...
NvParameterized::MutexType AttractorFSAssetParams_0p0::mBuiltFlagMutex;

AttractorFSAssetParams_0p0::AttractorFSAssetParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* AttractorFSAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* AttractorFSAssetParams_0p0::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType AttractorFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType AttractorFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFSAssetParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
