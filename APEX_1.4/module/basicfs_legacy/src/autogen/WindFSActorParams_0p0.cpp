...
using namespace WindFSActorParams_0p0NS;

const char* const WindFSActorParams_0p0Factory::vptr =
    NvParameterized::getVptr<WindFSActorParams_0p0, WindFSActorParams_0p0::ClassAlignment>();
...
bool WindFSActorParams_0p0::mBuiltFlag = false;
NvParameterized::MutexType WindFSActorParams_0p0::mBuiltFlagMutex;

WindFSActorParams_0p0::WindFSActorParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &WindFSActorParams_0p0FactoryInst);
...
WindFSActorParams_0p0::~WindFSActorParams_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void WindFSActorParams_0p0::destroy()
{
	...
	this->~WindFSActorParams_0p0();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* WindFSActorParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* WindFSActorParams_0p0::getParameterDefinitionTree(void) const
{
	WindFSActorParams_0p0* tmpParam = const_cast<WindFSActorParams_0p0*>(this);
...
NvParameterized::ErrorType WindFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType WindFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void WindFSActorParams_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<WindFSActorParams_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void WindFSActorParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void WindFSActorParams_0p0::buildTree(void)
{
...
void WindFSActorParams_0p0::initStrings(void)
{
...
void WindFSActorParams_0p0::initDynamicArrays(void)
{
}

void WindFSActorParams_0p0::initDefaults(void)
{
...
void WindFSActorParams_0p0::initReferences(void)
{
}

void WindFSActorParams_0p0::freeDynamicArrays(void)
{
}

void WindFSActorParams_0p0::freeStrings(void)
{
...
void WindFSActorParams_0p0::freeReferences(void)
{
}
