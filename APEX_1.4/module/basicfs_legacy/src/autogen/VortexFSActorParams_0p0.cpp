...
using namespace VortexFSActorParams_0p0NS;

const char* const VortexFSActorParams_0p0Factory::vptr =
    NvParameterized::getVptr<VortexFSActorParams_0p0, VortexFSActorParams_0p0::ClassAlignment>();
...
bool VortexFSActorParams_0p0::mBuiltFlag = false;
NvParameterized::MutexType VortexFSActorParams_0p0::mBuiltFlagMutex;

VortexFSActorParams_0p0::VortexFSActorParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &VortexFSActorParams_0p0FactoryInst);
...
VortexFSActorParams_0p0::~VortexFSActorParams_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void VortexFSActorParams_0p0::destroy()
{
	...
	this->~VortexFSActorParams_0p0();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* VortexFSActorParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* VortexFSActorParams_0p0::getParameterDefinitionTree(void) const
{
	VortexFSActorParams_0p0* tmpParam = const_cast<VortexFSActorParams_0p0*>(this);
...
NvParameterized::ErrorType VortexFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType VortexFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VortexFSActorParams_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<VortexFSActorParams_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void VortexFSActorParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void VortexFSActorParams_0p0::buildTree(void)
{
...
void VortexFSActorParams_0p0::initStrings(void)
{
...
void VortexFSActorParams_0p0::initDynamicArrays(void)
{
}

void VortexFSActorParams_0p0::initDefaults(void)
{
...
void VortexFSActorParams_0p0::initReferences(void)
{
}

void VortexFSActorParams_0p0::freeDynamicArrays(void)
{
}

void VortexFSActorParams_0p0::freeStrings(void)
{
...
void VortexFSActorParams_0p0::freeReferences(void)
{
}
