...
const char* const JetFSAssetParams_0p1Factory::vptr =
    NvParameterized::getVptr<JetFSAssetParams_0p1, JetFSAssetParams_0p1::ClassAlignment>();
...
NvParameterized::MutexType JetFSAssetParams_0p1::mBuiltFlagMutex;

JetFSAssetParams_0p1::JetFSAssetParams_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* JetFSAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* JetFSAssetParams_0p1::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType JetFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType JetFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFSAssetParams_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
