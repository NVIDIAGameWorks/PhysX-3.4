...
const char* const WindFSAssetParams_0p0Factory::vptr =
    NvParameterized::getVptr<WindFSAssetParams_0p0, WindFSAssetParams_0p0::ClassAlignment>();
...
NvParameterized::MutexType WindFSAssetParams_0p0::mBuiltFlagMutex;

WindFSAssetParams_0p0::WindFSAssetParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* WindFSAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* WindFSAssetParams_0p0::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType WindFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType WindFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void WindFSAssetParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
