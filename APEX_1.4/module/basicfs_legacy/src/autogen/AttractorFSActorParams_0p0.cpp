...
using namespace AttractorFSActorParams_0p0NS;

const char* const AttractorFSActorParams_0p0Factory::vptr =
    NvParameterized::getVptr<AttractorFSActorParams_0p0, AttractorFSActorParams_0p0::ClassAlignment>();
...
bool AttractorFSActorParams_0p0::mBuiltFlag = false;
NvParameterized::MutexType AttractorFSActorParams_0p0::mBuiltFlagMutex;

AttractorFSActorParams_0p0::AttractorFSActorParams_0p0(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &AttractorFSActorParams_0p0FactoryInst);
...
AttractorFSActorParams_0p0::~AttractorFSActorParams_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void AttractorFSActorParams_0p0::destroy()
{
	...
	this->~AttractorFSActorParams_0p0();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* AttractorFSActorParams_0p0::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* AttractorFSActorParams_0p0::getParameterDefinitionTree(void) const
{
	AttractorFSActorParams_0p0* tmpParam = const_cast<AttractorFSActorParams_0p0*>(this);
...
NvParameterized::ErrorType AttractorFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType AttractorFSActorParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFSActorParams_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<AttractorFSActorParams_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void AttractorFSActorParams_0p0::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void AttractorFSActorParams_0p0::buildTree(void)
{
...
void AttractorFSActorParams_0p0::initStrings(void)
{
...
void AttractorFSActorParams_0p0::initDynamicArrays(void)
{
}

void AttractorFSActorParams_0p0::initDefaults(void)
{
...
void AttractorFSActorParams_0p0::initReferences(void)
{
}

void AttractorFSActorParams_0p0::freeDynamicArrays(void)
{
}

void AttractorFSActorParams_0p0::freeStrings(void)
{
...
void AttractorFSActorParams_0p0::freeReferences(void)
{
}
