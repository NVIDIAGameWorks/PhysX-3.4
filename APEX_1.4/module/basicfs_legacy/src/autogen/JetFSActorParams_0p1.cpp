...
using namespace JetFSActorParams_0p1NS;

const char* const JetFSActorParams_0p1Factory::vptr =
    NvParameterized::getVptr<JetFSActorParams_0p1, JetFSActorParams_0p1::ClassAlignment>();
...
bool JetFSActorParams_0p1::mBuiltFlag = false;
NvParameterized::MutexType JetFSActorParams_0p1::mBuiltFlagMutex;

JetFSActorParams_0p1::JetFSActorParams_0p1(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
	NvParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &JetFSActorParams_0p1FactoryInst);
...
JetFSActorParams_0p1::~JetFSActorParams_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void JetFSActorParams_0p1::destroy()
{
	...
	this->~JetFSActorParams_0p1();

	NvParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NvParameterized::DefinitionImpl* JetFSActorParams_0p1::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* JetFSActorParams_0p1::getParameterDefinitionTree(void) const
{
	JetFSActorParams_0p1* tmpParam = const_cast<JetFSActorParams_0p1*>(this);
...
NvParameterized::ErrorType JetFSActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType JetFSActorParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFSActorParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<JetFSActorParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void JetFSActorParams_0p1::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void JetFSActorParams_0p1::buildTree(void)
{
...
void JetFSActorParams_0p1::initStrings(void)
{
...
void JetFSActorParams_0p1::initDynamicArrays(void)
{
}

void JetFSActorParams_0p1::initDefaults(void)
{
...
void JetFSActorParams_0p1::initReferences(void)
{
}

void JetFSActorParams_0p1::freeDynamicArrays(void)
{
}

void JetFSActorParams_0p1::freeStrings(void)
{
...
void JetFSActorParams_0p1::freeReferences(void)
{
}
