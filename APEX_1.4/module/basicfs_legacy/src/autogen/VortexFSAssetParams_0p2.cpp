...
const char* const VortexFSAssetParams_0p2Factory::vptr =
    NvParameterized::getVptr<VortexFSAssetParams_0p2, VortexFSAssetParams_0p2::ClassAlignment>();
...
NvParameterized::MutexType VortexFSAssetParams_0p2::mBuiltFlagMutex;

VortexFSAssetParams_0p2::VortexFSAssetParams_0p2(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* VortexFSAssetParams_0p2::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* VortexFSAssetParams_0p2::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType VortexFSAssetParams_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType VortexFSAssetParams_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VortexFSAssetParams_0p2::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
