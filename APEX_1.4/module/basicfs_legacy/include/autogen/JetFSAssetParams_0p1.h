...
#ifndef NV_PARAMETERIZED_ONLY_LAYOUTS
class JetFSAssetParams_0p1 : public NvParameterized::NvParameters, public JetFSAssetParams_0p1NS::ParametersStruct
{
public:
	JetFSAssetParams_0p1(NvParameterized::Traits* traits, void* buf = 0, int32_t* refCount = 0);
...
class JetFSAssetParams_0p1Factory : public NvParameterized::Factory
{
...
public:
	...
	{
		JetFSAssetParams_0p1::freeParameterDefinitionTable(traits);
	}
	...
	virtual NvParameterized::Interface* create(NvParameterized::Traits* paramTraits)
	{
		...
		if (!NvParameterized::IsAligned(newPtr, JetFSAssetParams_0p1::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class JetFSAssetParams_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(JetFSAssetParams_0p1)); // always initialize memory allocated to zero for default values
		return NV_PARAM_PLACEMENT_NEW(newPtr, JetFSAssetParams_0p1)(paramTraits);
	}

	virtual NvParameterized::Interface* finish(NvParameterized::Traits* paramTraits, void* bufObj, void* bufStart, int32_t* refCount)
	{
		if (!NvParameterized::IsAligned(bufObj, JetFSAssetParams_0p1::ClassAlignment)
		        || !NvParameterized::IsAligned(bufStart, JetFSAssetParams_0p1::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class JetFSAssetParams_0p1");
			return 0;
		}
