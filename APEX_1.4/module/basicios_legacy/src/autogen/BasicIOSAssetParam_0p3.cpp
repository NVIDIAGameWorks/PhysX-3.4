...
const char* const BasicIOSAssetParam_0p3Factory::vptr =
    NvParameterized::getVptr<BasicIOSAssetParam_0p3, BasicIOSAssetParam_0p3::ClassAlignment>();
...
NvParameterized::MutexType BasicIOSAssetParam_0p3::mBuiltFlagMutex;

BasicIOSAssetParam_0p3::BasicIOSAssetParam_0p3(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_0p3::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_0p3::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p3::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
