...
const char* const BasicIOSAssetParam_0p8Factory::vptr =
    NvParameterized::getVptr<BasicIOSAssetParam_0p8, BasicIOSAssetParam_0p8::ClassAlignment>();
...
NvParameterized::MutexType BasicIOSAssetParam_0p8::mBuiltFlagMutex;

BasicIOSAssetParam_0p8::BasicIOSAssetParam_0p8(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_0p8::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_0p8::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_0p8::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_0p8::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p8::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_0p8::initDefaults(void)
{
	...
	FakeDensityDistance = float(10);
	UseFakeDensityGrid = bool(0);
	FakeDensityGridSize = float(10);
	FakeDensityGridMaxCellCount = uint32_t(16);
