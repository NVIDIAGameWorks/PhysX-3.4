...
const char* const BasicIOSAssetParam_1p3Factory::vptr =
    NvParameterized::getVptr<BasicIOSAssetParam_1p3, BasicIOSAssetParam_1p3::ClassAlignment>();
...
NvParameterized::MutexType BasicIOSAssetParam_1p3::mBuiltFlagMutex;

BasicIOSAssetParam_1p3::BasicIOSAssetParam_1p3(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_1p3::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_1p3::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_1p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_1p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_1p3::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
