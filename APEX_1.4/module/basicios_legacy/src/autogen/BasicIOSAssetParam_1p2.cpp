...
const char* const BasicIOSAssetParam_1p2Factory::vptr =
    NvParameterized::getVptr<BasicIOSAssetParam_1p2, BasicIOSAssetParam_1p2::ClassAlignment>();
...
NvParameterized::MutexType BasicIOSAssetParam_1p2::mBuiltFlagMutex;

BasicIOSAssetParam_1p2::BasicIOSAssetParam_1p2(NvParameterized::Traits* traits, void* buf, int32_t* refCount) :
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_1p2::getParameterDefinitionTree(void)
{
...
const NvParameterized::DefinitionImpl* BasicIOSAssetParam_1p2::getParameterDefinitionTree(void) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_1p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NvParameterized::ErrorType BasicIOSAssetParam_1p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NvParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_1p2::freeParameterDefinitionTable(NvParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
