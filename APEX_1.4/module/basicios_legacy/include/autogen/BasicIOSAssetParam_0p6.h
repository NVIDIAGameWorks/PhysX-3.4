...
static const uint32_t checksum[] = { 0xf6d69e51, 0x7edca183, 0xb8953089, 0xdd758d6f, };

} // namespace BasicIOSAssetParam_0p6NS

#ifndef NV_PARAMETERIZED_ONLY_LAYOUTS
class BasicIOSAssetParam_0p6 : public NvParameterized::NvParameters, public BasicIOSAssetParam_0p6NS::ParametersStruct
{
public:
	BasicIOSAssetParam_0p6(NvParameterized::Traits* traits, void* buf = 0, int32_t* refCount = 0);
...
class BasicIOSAssetParam_0p6Factory : public NvParameterized::Factory
{
...
public:
	...
	{
		BasicIOSAssetParam_0p6::freeParameterDefinitionTable(traits);
	}
	...
	virtual NvParameterized::Interface* create(NvParameterized::Traits* paramTraits)
	{
		...
		if (!NvParameterized::IsAligned(newPtr, BasicIOSAssetParam_0p6::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BasicIOSAssetParam_0p6");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(BasicIOSAssetParam_0p6)); // always initialize memory allocated to zero for default values
		return NV_PARAM_PLACEMENT_NEW(newPtr, BasicIOSAssetParam_0p6)(paramTraits);
	}

	virtual NvParameterized::Interface* finish(NvParameterized::Traits* paramTraits, void* bufObj, void* bufStart, int32_t* refCount)
	{
		if (!NvParameterized::IsAligned(bufObj, BasicIOSAssetParam_0p6::ClassAlignment)
		        || !NvParameterized::IsAligned(bufStart, BasicIOSAssetParam_0p6::ClassAlignment))
		{
			NV_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class BasicIOSAssetParam_0p6");
			return 0;
		}
